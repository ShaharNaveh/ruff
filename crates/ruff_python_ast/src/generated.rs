...
impl<'a> AnyNodeRef<'a> {
    pub const fn as_mod_ref(self) -> Option<ModRef<'a>> {
        match self {
...
impl<'a> AnyNodeRef<'a> {
    pub const fn as_stmt_ref(self) -> Option<StmtRef<'a>> {
        match self {
...
impl<'a> AnyNodeRef<'a> {
    pub const fn as_expr_ref(self) -> Option<ExprRef<'a>> {
        match self {
...
impl<'a> AnyNodeRef<'a> {
    pub const fn as_except_handler_ref(self) -> Option<ExceptHandlerRef<'a>> {
        match self {
...
impl<'a> AnyNodeRef<'a> {
    pub const fn as_interpolated_string_element_ref(
        self,
    ) -> Option<InterpolatedStringElementRef<'a>> {
        match self {
...
impl<'a> AnyNodeRef<'a> {
    pub const fn as_pattern_ref(self) -> Option<PatternRef<'a>> {
        match self {
...
impl<'a> AnyNodeRef<'a> {
    pub const fn as_type_param_ref(self) -> Option<TypeParamRef<'a>> {
        match self {
